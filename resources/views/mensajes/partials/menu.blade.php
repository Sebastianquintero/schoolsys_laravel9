<div class="container-fluid sb1">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 mob-hide">
            <form class="app-search" action="{{ url()->current() }}" method="GET">
                <input type="text" name="q" placeholder="Buscar…" class="form-control" value="{{ request('q') }}">
                <a><button type="submit" class="btn btn-link p-0"><i class="fa fa-search"></i></button></a>
            </form>
        </div>
