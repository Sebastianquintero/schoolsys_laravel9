            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Import Docentes</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Importar Docentes</h4>
                                    <p>Todo acerca de los docentes con la plantilla</p>
                                </div>
                                <div class="tab-inn">
                                    @if(session('mensaje'))
                                    ...
                                    @endif
                                    <form action="{{ route('importar.docentes') }}" method="POST"
