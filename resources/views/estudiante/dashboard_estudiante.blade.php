    ...
    <div class="container-fluid sb1">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="{{ url('/welcome') }}"><h1 class="m0">ScholSys</h1></a>
            </div>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="{{ url('estudiante_profesor') }}">Profesores</a></li>
                                    <li><a href="{{ url('encuesta') }}">Encuestas</a></li>
            ...
            <div class="sb2-2">
                ...
                <div class="message-block">
                    <div class="message-container">
                        ...
                        <p class="message-text">No te pierdas nuestra nueva actualización del sistema ScholSys, que trae mejoras en la gestión de estudiantes y comunicación. ¡Mantente al tanto de las novedades!</p>
                    </div>
                </div>
                <div class="message-block">
                    <div class="message-container">
                ...
                <div class="message-block">
                    <div class="message-container">
                        ...
                        <p class="message-text">No te pierdas nuestra nueva actualización ¡Mantente al tanto de las novedades!</p>
                    </div>
                </div>
