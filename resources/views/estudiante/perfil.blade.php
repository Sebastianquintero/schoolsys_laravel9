    ...
    <div class="container-fluid sb1">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="{{ url('/') }}" class="a"><h1 class="m0">ScholSys</h1></a>
            </div>
            ...
            <div class="col-md-2 tab-hide">
                <div class="top-not-cen">
                    <a class='waves-effect btn-noti' href="{{ url('dashboard_estudiante') }}"><i class="fa fa-commenting-o"></i><span>1</span></a>
                    <a class='waves-effect btn-noti' href="{{ url('mail') }}"><i class="fa fa-envelope-o"></i><span>1</span></a>
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    <li><a href="{{ url('profile') }}" class="waves-effect"><i class="fa fa-cogs"></i>Configuración de perfil</a></li>
                    <li class="divider"></li>
                    <li><a href="#" class="ho-dr-con-last waves-effect"><i class="fa fa-sign-in"></i>Cerrar sesión</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <ul class="collapsible" data-collapsible="accordion">
                        <li>
                            ...
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="{{ url('dashboard_estudiante') }}">Noticias</a></li>
                                    <li><a href="{{ url('profile') }}">Perfil</a></li>
                                    <li><a href="{{ url('info_personal') }}">Información Personal</a></li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="{{ url('estudiante-prof') }}">Profesores</a></li>
                        ...
                        <li>
                            <a href="{{ url('mail') }}" class="collapsible-header"><i class="fa fa-users"></i> Correo</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <form action="#" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-control" value="Victoria Baker" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="email">Correo Electrónico:</label>
                                <input type="email" id="email" name="email" class="form-control" value="victoria@example.com" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="telefono">Teléfono:</label>
                                <input type="text" id="telefono" name="telefono" class="form-control" value="123-456-7890" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="direccion">Dirección:</label>
                                <input type="text" id="direccion" name="direccion" class="form-control" value="Bogotá D.C." readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="fecha-nacimiento">Fecha de Nacimiento:</label>
                                <input type="date" id="fecha-nacimiento" name="fecha-nacimiento" class="form-control" value="1998-04-25" readonly>
                            </div>
                        </div>
                    </form>
                </div>
